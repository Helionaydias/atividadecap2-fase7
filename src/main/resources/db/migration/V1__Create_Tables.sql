...
-- Criação da tabela TB_MOTORISTA (antes de TB_COLETA)
...
-- Criação da tabela TB_CAMINHAO (antes de TB_COLETA)
...
-- Criação da tabela TB_COLETA (após TB_MOTORISTA e TB_CAMINHAO)
